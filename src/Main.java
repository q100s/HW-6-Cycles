public class Main {
    ...
    public static void task9() {
        ...
        double newSave = 29000;
        double newTotal = 0;
        for (int x = 1; x <= 12; x++) {
            newTotal = (newTotal + newTotal / 100) + newSave;
            System.out.printf("In the " + x + "th month the sum of saving is %.2f rubles \n" ,newTotal);
        }
    }
    ...
    public static void task13() {
        ...
        double birtRateForThousand = 17;
        double mortalityForThousand = 8;
        int year = 0;
        while (year < 10) {
            year = year + 1;
            double birthRateOfCountry = population / 1000 * birtRateForThousand;
            double mortalityOfCountry = population / 1000 * mortalityForThousand;
            population = population + birthRateOfCountry - mortalityOfCountry;
            System.out.printf("Population in the " + year + "th year is %.2f units \n", population);
        }
    }
    public static void task14() {
        ...
        while (money < 12_000_000) {
            ...
            System.out.printf("In the " + month + "th month saving is %.2f rubles \n", money);
        }
    }
